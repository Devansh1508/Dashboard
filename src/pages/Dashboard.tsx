...
const Dashboard = () => {
  ...
  const [existingRole, setExistingRole] = useState<{ id: number; roleName: string; description: string; permissions: Permission[] } | undefined>(undefined);
  ...
  return (
    <>
      ...
      >
        <AddRole existingRole={existingRole} />
      </div>
      <ToastContainer />
    </>
  );
